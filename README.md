...
- `index.html` — the entire app in one self-contained file (HTML + CSS + JS + all 839 cards inlined). This is the only file you need to run or deploy.
...
1. Create a new public GitHub repo (e.g., `triggers-cards`).
...
5. Wait ~30 seconds. Your site will be live at `https://<your-username>.github.io/triggers-cards/`.
...
4. Name it "Triggers" and tap Add.
...
3. Save.
4. In the `triggers-cards` folder, run: `python3 parse.py`
